    ...
    <script type="text/javascript">
            ...
            for (var i =0; i < 5; i++) {
                switch(i) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        if (searchType == "like_customer_name") {
                            textSearchType = "by cusotmer name (like)";
                        }
                        break;
                    case 3:
        ...
        function search(searchType, searchCriteria)
        {
            ...
            $("#search_result").jqxGrid({
                ...
                columns: [
                    ...
                    { text: 'Job ID', datafield: 'job_id', width: 60 },
                    ...
                    // { text: 'CC type', datafield: 'cc_type', width: 100, hidden:check_hidden(searchType, 'cc_type'), cellclassname: cellclass },

                    { text: 'Batch size', datafield: 'batch_size', width: 85 },
                    { text: 'Total items', datafield: 'total_items', width: 85 },
                    { text: 'Price per item', datafield: 'price_per_item', width: 110, cellsformat: 'c2' },
                    { text: 'Total value', datafield: 'total_value', width: 110, cellsformat: 'c2' },
        ...
        function getBatches()
        {
            ...
            if (!search_selected_cell_data) {
                alert("Please select a job in the search result.");
                return;
            }

            // document.getElementById('orders_header').innerHTML = "Batches for jobs "+ search_selected_cell_data.home_phone;
            document.getElementById('orders_header').innerHTML = "Batches for job: " + search_selected_cell_data.job_id;
            var theme = page_theme;
            var pathname = window.location.pathname;
            var urlpathname      = window.location.href;
            var url_params = "?cmd=batches_for_job_id&job_id=" + search_selected_cell_data.job_id;
            ...
            var order_source =
                {
                    ...
                    datafields: [
                        ...
                        { name: 'batch_Qty', type: 'string' },
                        { name: 'batch_value', type: 'string' },
                        { name: 'workstep_name', type: 'string' },
                        { name: 'inventory_location_name', type: 'string' },
            ...
            $("#batches_grid").jqxGrid({
                ...
                columns: [
                    ...
                    { text: 'Product name', datafield: 'product_name', width: 200 },
                    { text: 'Pull Job ID', datafield: 'shipping_job_id', width: 200 },
                    ...
                    { text: 'Inventory date', datafield: 'inventory_time', width: 120},
                    ...
                    { text: 'Workstep Name', datafield: 'workstep_name', width: 140 },
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="formInput102" placeholder="job id">
        ...
        <div class="col-md-4">
            <h3>Like customer name</h3>
            <div class="form-group">
                <!-- <label class="control-label" for="formInput17">customer name: &nbsp;</label> -->
                <input type="text" class="form-control" id="formInput17" placeholder="customer name">
            </div>
            <button onclick="search('like_customer_name', makeArgs('&amp;customer_name=')+document.getElementById('formInput17').value)"> Search </button>
        </div>
        <BR>
        <BR>
    </div>
    ...
    <div class="row">
        ...
        <BR>
        <BR>
        <input style="margin-left: 25px;width:250px;min-width:250px;" id="show_batches" type="button" onclick="getBatches()" value="Batches for selected job ID" />
        ...
        <div id="batches_div" class="">
            <div class="jumbotron">
                <h2 id="orders_header">Batches</h2>
            </div>
